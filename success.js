...
function getSuccessHTML(lang = 'en', fulfillStatus = 'processing') {
    ...
    const t = lang === 'es' ? {
        ...
        portalNote: `Información de cancelación del monitoreo recurrente: ${getSupportEmail()} o portal de facturación en su correo de activación. Ver Términos.`,
        ...
        portalNote: `Recurring monitoring cancellation: ${getSupportEmail()} or billing portal in your activation email. See Terms.`,
