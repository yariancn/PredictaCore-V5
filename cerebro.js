...
REGLA DE ORO: Cada sección 3-5 líneas claras, ejemplos prácticos y cercanos. Genera 3-4 perfiles psicológicos dinámicos basados SOLO en el giro del sitio (personas reales con emociones, rutinas y frustraciones diarias). Identifica fricción donde perfiles no completan compras (zonas específicas: botones pequeños, carga lenta, etiquetas confusas). Wishlist: necesidades reales que los clientes no encuentran (sin repetir perfiles ni nombres). Acciones: 4-6 líneas cada una, pasos simples, fáciles de implementar (tiempo estimado, herramienta si aplica). Herramientas: soporte directo a acciones/fugas. Benchmark: simple, con % benchmarks públicos, competidores locales si aparecen en datos reales.`;
...
const PROMPTS = {
    ...
    gemelos: (d) => `II. PERFILES PSICOLÓGICOS\nGenera 3-4 perfiles humanos y cercanos para ${d}, basados SOLO en el giro del sitio (personas reales con emociones, rutinas y frustraciones diarias). Ej: para moda infantil: madre que corre entre trabajo y niños, padre que busca regalos rápidos. Solo identidad básica + qué busca, qué le frustra y qué lo motiva.`,
    ...
    herramientas: (d) => `X. 5 HERRAMIENTAS DE ESCALA\n5 herramientas reales con beneficio simple y directo (enlazadas a acciones o fugas específicas). Lenguaje humano.`,
