...
const PRIORIDAD_FUGAS = `SISTEMA DE PRIORIDAD OBLIGATORIO (15 fugas — PROHIBIDO marcar las 15 como hemorragia):
- Puntos 1-3: **[P1 — HEMORRAGIA CRÍTICA]** (EN: **[P1 — CRITICAL HEMORRHAGE]**) — bloquean conversión hoy; pérdida inmediata de visitantes/ventas.
- Puntos 4-8: **[P2 — FUGA GRAVE]** (EN: **[P2 — SEVERE LEAK]**) — fricción alta; abandono probable si no se corrige pronto.
- Puntos 9-12: **[P3 — FUGA MODERADA]** (EN: **[P3 — MODERATE LEAK]**) — fricción medible; planificar corrección en 30 días.
- Puntos 13-15: **[P4 — FRICCIÓN MENOR]** (EN: **[P4 — MINOR FRICTION]**) — pulido, profesionalismo y optimización fina.
Distribuye según impacto real de SIMULATION_RESULTS. Solo las 3 peores llevan P1.`;
...
const PROMPTS = {
  ...
  FUGAS: (d) => `${IDIOMA}\n${REGLA_NUCLEAR}\n${PRIORIDAD_FUGAS}\nEscribe este encabezado traducido: ### VIII. 15 PUNTOS DE FUGA\nEXACTAMENTE 15 líneas numeradas del 1. al 15. — PROHIBIDO viñetas • o -. Formato: 1. **[P1 — HEMORRAGIA CRÍTICA]** [hallazgo] (evidencia: evaluación #id). OBLIGATORIO: prioriza FALLAS de SIMULATION_RESULTS + capturas + dossier. PROHIBIDO citar evaluación #16 o superior. ${FORMATO_LISTAS}. Impacto cualitativo en conversión — PROHIBIDO $. Dossier: ${d}`,
