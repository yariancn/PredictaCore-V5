...
const PROMPTS = {
    ...
    Define la empresa como una unidad de ingeniería forense de conversión. Explica brevemente el uso de Gemelos Sintéticos y la metodología de 'trabajo contratado' (JTBD). Es la única sección de presentación.`,

    DNA: (dna) => `Realiza el DIAGNÓSTICO DE INGENIERÍA de 5 PUNTOS para ${dna}. 
    Puntos obligatorios: 
    1. Arquitectura de Navegación y flujo de conversión. 
    2. Transparencia Técnica (Activos críticos omitidos según el giro del negocio). 
    3. Semiótica Visual (Señales de autoridad vs. desconfianza). 
    4. Visión de Google (Qué ve el algoritmo y por qué prioriza a la competencia o marketplaces). 
    5. Percepción Algorítmica de los Gemelos (Cómo el posicionamiento afecta la confianza inicial).`,
    ...
    Nota: Limítate estrictamente a su identidad, motivaciones y miedos psicológicos profundos. No incluyas críticas técnicas aquí.`,
...
module.exports = { PERSONA, PROMPTS };    WISHLIST: (dna) => `LISTA DE DESEOS ESTRATÉGICA para ${dna}. 
    Enumera 5 activos de alta gama que el sitio NO tiene y que el cliente sueña encontrar para pagar sin dudar.`,
