...
const PROMPTS = {
    ...
    1. Arquitectura de Navegación y flujo. 2. Transparencia Técnica (Activos omitidos según giro). 3. Semiótica Visual (Autoridad vs Desconfianza). 4. Visión de Google (SEO local y canibalización). 5. Percepción Algorítmica (Cómo el ranking afecta la confianza del gemelo).`,

    GEMELOS: (dna) => `Define el PERFIL PSICOLÓGICO de 2 Gemelos Sintéticos para ${dna}. 
    1. ANA: Compradora emocional y de seguridad. 2. ROBERTO: Comprador de estatus y eficiencia. 
    Nota: Limítate a su identidad y motivaciones. No incluyas críticas técnicas de la página aquí.`,
    ...
    Analiza SEO de intención, canibalización de plataformas externas y presencia local (Maps/Google Business) desde la perspectiva de autoridad de dominio.`,
    ...
    Analiza Fortalezas, Oportunidades, Debilidades (fugas de navegación) y Amenazas (commodities). 5 líneas por punto.`,
    ...
    Formato: 'Lo que tienes que hacer: [Acción]'. Usa lógica condicional: 'Si el cliente no encuentra X, entonces instala Y'.`,

    HERRAMIENTAS: (dna) => `5 HERRAMIENTAS DE ESCALA para ${dna}. 
    Cita software real (Zakeke, Loox, Klaviyo, Gorgias, Lucky Orange) y su beneficio financiero en la conversión.`,

    OMNI: (dna) => `HOJA DE RUTA DE 21 DÍAS para ${dna}. 
    Divide en 3 semanas de ejecución técnica y estratégica para blindar la conversión.`
};
