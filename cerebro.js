...
const PROMPTS = {
    ...
    VISIBILIDAD: (dna) => `Escaneo de visibilidad externa para ${dna}. 1. Posicionamiento en Google/Maps. 2. Reputación percibida por gemelos (Sentimiento). 3. Estrategia de Redes (Si aplica). (3-5 líneas por punto).`,
