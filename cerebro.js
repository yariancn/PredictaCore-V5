...
const PROMPTS = {
  ...
  SCORECARD: (d) => `${IDIOMA}\n${REGLA_NUCLEAR}\nEscribe este encabezado traducido al idioma detectado: ### III. SCORECARD DE SALUD COMERCIAL\nPresenta una tabla Markdown. Traduce esta cabecera: | Punto de Salud | Calificación (1-10) | Diagnóstico Forense |\nREGLAS: 10 filas exactas. PROHIBIDO usar saltos de línea en celdas. Evalúa puntos MACRO de negocio (Claridad de Oferta, Fricción Transaccional, Autoridad, Tangibilidad). [UNIVERSALIDAD]: Analiza la integridad del Nodo de Cierre; identifica si elementos de pago rápido o pasarelas externas están canibalizando la intención de compra o creando una ruptura en la psicología del cliente. Diagnósticos de 3 líneas. Dossier: ${d}`,
  ...
  FUGAS: (d) => `${IDIOMA}\n${REGLA_NUCLEAR}\nEscribe este encabezado traducido al idioma detectado: ### VIII. 15 PUNTOS DE FUGA\nIdentifica 15 hallazgos críticos de fricción. Marca las peores como **[HEMORRAGIA CRÍTICA]**. REGLAS:\n1. ${FORMATO_LISTAS} (Numera del 1 al 15).\n2. Evalúa ERRORES MICRO (botones, usabilidad, contraste, carga) basándote en las imágenes y el dossier. [UNIVERSALIDAD]: Identifica si el proceso de pago rápido o elementos externos están bloqueando la visibilidad del botón principal o forzando saltos de ecosistema innecesarios que detienen la venta. Explica el impacto financiero de cada fuga. Dossier: ${d}`,
