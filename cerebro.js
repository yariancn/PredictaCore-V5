...
const PROMPTS = {
    ...
    1. Arquitectura de Navegación. 2. Transparencia Técnica (Activos omitidos). 3. Semiótica Visual. 4. Visión de Google (SEO local/Canibalización). 5. Percepción Algorítmica de los Gemelos.`,
    ...
    Nota: Limítate estrictamente a su identidad y motivaciones psicológicas profundas.`,

    SCORECARD: (dna) => `Genera el SCORECARD DE 10 PUNTOS para ${dna}: 
    1. Gancho, 2. Pricing, 3. Misión de Compra, 4. Jerarquía de Botones, 5. Visibilidad Técnica, 6. Confianza, 7. Prueba Social, 8. Navegación Móvil, 9. Autoridad, 10. Soporte. 
    Califica y da 5 líneas de análisis por punto.`,

    VISIBILIDAD: (dna) => `AUDITORÍA DE VISIBILIDAD EXTERNA para ${dna}. 
    Analiza SEO de intención, canibalización de plataformas externas y presencia local desde la autoridad de marca.`,

    BENCHMARK: (dna) => `BENCHMARKING DE NICHO para ${dna}. 
    Compara contra los 3 líderes del sector e identifica qué activos técnicos tienen ellos que este sitio omite.`,

    SWOT: (dna) => `MATRIZ ESTRATÉGICA PROFUNDA para ${dna}. 
    Analiza Fortalezas, Oportunidades, Debilidades y Amenazas. 5 líneas de análisis por cada cuadrante.`,
    ...
    Analiza errores técnicos, falta de información específica del giro y fallas de pricing. 5 líneas por fuga.`,
    ...
    Software real (ej. Zakeke, Loox, Klaviyo, Gorgias, Lucky Orange) y su beneficio financiero directo.`,
