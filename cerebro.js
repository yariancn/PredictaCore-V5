...
const PROMPTS = {
  INTRO: (d) => `${IDIOMA}\n${REGLA_NUCLEAR}\n${PILARES_11}\nEscribe este encabezado traducido: ### I. INTRODUCCIÓN, RESUMEN EJECUTIVO Y RADIOGRAFÍA\nPARTE A — RESUMEN EJECUTIVO (OBLIGATORIO PRIMERO): Tabla Markdown con filas: Tiempo de carga (TIEMPO_CARGA_SEG), SEO técnico (SEO_TECNICO_SCORE), Visibilidad IA (AI_DISCOVERABILITY_SCORE), Giro detectado (GIRO_DETECTADO), Veredicto forense (1 frase). 3 bullets de hallazgos críticos.\nPARTE B — Metodología PredictaCore (1 párrafo): gemelos sintéticos = clientes ideales con perfil psicológico según el giro del negocio; simulaciones buscan fricción de conversión, confianza, claridad de oferta y visibilidad (usa OBJETIVO_SIMULACIONES del dossier). PROHIBIDO citar cantidad de simulaciones o visitas.\nPARTE C — Radiografía del negocio (2 párrafos): qué venden, mercado, modelo. PROHIBIDO diagnosticar aquí. Dossier: ${d}`,
