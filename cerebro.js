...
const PROMPTS = {
  ...
  FUGAS: (d) => `${IDIOMA}\n${REGLA_NUCLEAR}\nEscribe este encabezado traducido: ### VIII. 15 PUNTOS DE FUGA\nEXACTAMENTE 15 líneas numeradas del 1. al 15. — PROHIBIDO viñetas • o -. Cada línea = 1. [hallazgo]. OBLIGATORIO: prioriza FALLAS de SIMULATION_RESULTS + capturas + dossier. Cada punto debe citar evidencia (evaluación #id, CTAS_INICIO, SEO_FORENSICS, etc.). Marca peores como **[HEMORRAGIA CRÍTICA]**. ${FORMATO_LISTAS}. Impacto cualitativo en conversión — PROHIBIDO $. Dossier: ${d}`,
