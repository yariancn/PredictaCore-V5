...
const PROMPTS = {
    INTRO: (dna) => `Genera la INTRODUCCIÓN CORPORATIVA de PredictaCore para ${dna}. Explica quiénes somos y la metodología forense (Gemelos Sintéticos y JTBD).`,
    DNA: (dna) => `DIAGNÓSTICO DE INGENIERÍA de 5 PUNTOS para ${dna}: 1. Arquitectura de Navegación, 2. Transparencia Técnica, 3. Semiótica Visual, 4. Visión de Google (SEO), 5. Percepción de los Gemelos.`,
    GEMELOS: (dna) => `Define el PERFIL PSICOLÓGICO de 2 Gemelos Sintéticos para ${dna}: ANA (Seguridad/Emoción) y ROBERTO (Estatus/Eficiencia). Limítate a su identidad psicológica profunda.`,
    SCORECARD: (dna) => `Genera el SCORECARD DE 10 PUNTOS para ${dna}. Califica de 1 a 10 y da 5 líneas de análisis forense por punto.`,
