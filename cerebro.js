...
const PROMPTS = {
  ...
  BENCHMARK: (d) => `${IDIOMA}\n${REGLA_NUCLEAR}\nEscribe este encabezado traducido: ### V. BENCHMARK COMPETITIVO\nOBLIGATORIO: Lee BENCHMARK_VERIFIED y PERFIL_NEGOCIO.\n- Si ESCALA=PYME_BOUTIQUE: PROHIBIDO comparar con Amazon, Walmart, Target, Costco, eBay marketplace genérico u otros mega-retailers. Solo rivales del mismo nicho, escala similar y oferta comparable (personalizado, artesanal, DTC pequeño).\n- Si ESTADO=SIN_COMPETENCIA_IDENTIFICADA: NO uses tabla comparativa. Escribe 2-3 párrafos con MENSAJE_OBLIGATORIO. PROHIBIDO inventar competidores, bancos o plataformas (Wix, Santander, Shopify.com, etc.).\n- Si COMP_1..3 existen: Tabla Markdown compacta SOLO con esos dominios (máx 3 columnas competidor):\n| Criterio | Activo analizado | [dominio COMP_1] | [dominio COMP_2 si existe] | [dominio COMP_3 si existe] |\n| **Qué hacen / What they do** | (1 frase del negocio auditado) | (copia QUE_HACE de COMP_1) | (COMP_2) | (COMP_3) |\n| Claridad de oferta | ... | ... | ... | ... |\n| Señales de confianza | ... | ... | ... | ... |\n| Visibilidad en IAs | ... | ... | ... | ... |\nPROHIBIDO dominios fuera del dossier. PROHIBIDO añadir columnas Target/Walmart/Amazon. Máximo 2 frases cortas por celda. Dossier: ${d}`,
  ...
  FUGAS: (d) => `${IDIOMA}\n${REGLA_NUCLEAR}\n${PRIORIDAD_FUGAS}\nEscribe este encabezado traducido: ### VIII. 15 PUNTOS DE FUGA\nEXACTAMENTE 15 líneas numeradas 1. al 15. — PROHIBIDO viñetas • o -. PROHIBIDO códigos P1/P2/P3/P4. OBLIGATORIO: prioriza FALLAS de SIMULATION_RESULTS + capturas. PROHIBIDO evaluación #16+. ${FORMATO_LISTAS}. Impacto cualitativo — PROHIBIDO $. Dossier: ${d}`,
