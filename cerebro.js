...
const PROMPTS = {
    ...
    GEMELOS: (dna) => `Describe a los 2 Gemelos Sintéticos para ${dna}: ANA (Madre primeriza) y ROBERTO (Padrino/Estatus). Define sus perfiles.`,
    SCORECARD: (dna) => `Genera el SCORECARD PREDICTACORE de 10 puntos para ${dna}. Califica del 1 al 10 y da un análisis por cada punto.`,
    ...
    SWOT: (dna) => `Genera la Matriz Estratégica (FODA) para ${dna} con análisis de impacto.`,
    WISHLIST: (dna) => `Lista de Deseos Estratégica para ${dna}. Qué falta en el sitio para que el cliente compre ya.`,
    ...
    AUTORIDAD: (dna) => `Genera la Autoridad y Hoja de Ruta de 21 días para ${dna}.`
};
