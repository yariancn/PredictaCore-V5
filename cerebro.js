const PROMPTS = {
  ...
  Presenta una tabla Markdown usando barras (|) con colores evaluando los 10 puntos de salud comercial. Verde para Óptimo, Amarillo para Necesario, Rojo para Urgente. Califica de 1 a 10.`,

  VISIBILIDAD: (d) => `Inicia tu respuesta con este encabezado: ### IV. VISIBILIDAD EXTERNA
  Realiza un análisis profundo de la brecha de intención en Google. Explica exhaustivamente cómo clasifica el algoritmo al activo, qué ve la gente a través de Google, qué información vital está bloqueada en imágenes y explica la pérdida de capital por falta de términos transaccionales.`,

  BENCHMARK: (d) => `Inicia tu respuesta con este encabezado: ### V. RADIOGRAFÍA ESTRATÉGICA (BENCHMARK)
  Presenta una tabla Markdown usando barras (|) comparando con 3 competidores. Evalúa 3 puntos clave para cada uno e incluye indicadores de colores para mostrar visualmente quién domina la Facilidad de Cierre.`,
  ...
  Enumera exactamente 10 deseos que faciliten la transacción. Cada deseo debe tener entre 3 y 5 líneas de texto. No menciones quién los pide ni uses 'demandas'.`,

  FUGAS: (d) => `Inicia tu respuesta con este encabezado: ### VIII. 15 PUNTOS DE FUGA
  Identifica 15 hallazgos críticos. Cada fuga debe tener estrictamente entre 3 y 5 líneas de texto, explicando a fondo el hallazgo y el problema real que causa.`,

  ACCIONES: (d) => `Inicia tu respuesta con este encabezado: ### IX. 15 ACCIONES TÁCTICAS
  Explica cómo corregir cada uno de los 15 hallazgos. Cada acción debe tener estrictamente entre 3 y 5 líneas de texto. Usa el nombre del hallazgo en **negritas** seguido de la explicación. Cero tecnicismos.`,
