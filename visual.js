...
<body>
    <div class="container">
        ...
        <div id="ui-input">
            ...
            <br>
            <button onclick="start()">Launch Audit</button>
        </div>
        <div id="progress-wrapper">
            <div id="progress-container"><div id="progress-bar"></div></div>
            <div id="status-text">Probing System...</div>
        </div>
    ...
    <script>
        ...
        async function start() {
            ...
            if(!dna) return alert("URL Missing");
        ...
        async function getPDF() {
            const res = await fetch('/generate-pdf', { method: 'POST', headers: {'Content-Type': 'application/json'}, body: JSON.stringify({html: reportData}) });
