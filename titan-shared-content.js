...
function getTitanPageCopy(lang, priceUsd, monitoringUsd) {
    ...
    return es
        ? {
            ...
            monitoringTitle: 'Opcional: monitoreo mensual (USD $' + monitoringUsd + '/mes desde día 30)',
            monitoringBody: 'Sin marcar = solo Titán hoy (USD $' + priceUsd + '), sin suscripción. Si marcas, un reporte mensual de seguimiento empieza el día 30. Cancela por correo o portal Stripe al menos 5 días hábiles antes del cobro.',
            ...
            faq: [
                ...
                { q: '¿Qué es el cargo de $' + monitoringUsd + '/mes?', a: 'Add-on opcional. Solo se cobra si marcas la casilla en el checkout. Empieza el día 30. El reporte Titán (USD $' + priceUsd + ') es un pago único.' },
        ...
        : {
            ...
            monitoringTitle: 'Optional: monthly monitoring (USD $' + monitoringUsd + '/mo from day 30)',
            monitoringBody: 'Unchecked = Titan only today (USD $' + priceUsd + '), no subscription. If you check this, a monthly follow-up report starts after 30 days. Cancel via email or Stripe portal at least 5 business days before renewal.',
            ...
            faq: [
                ...
                { q: 'What is the $' + monitoringUsd + '/mo charge?', a: 'Optional add-on. Only charged if you check the box at checkout. Starts day 30. Today\'s Titan Report (USD $' + priceUsd + ') is a one-time payment.' },
