...
const PROMPTS = {
  ...
  BENCHMARK: (d) => `${IDIOMA}\n${REGLA_NUCLEAR}\nEscribe este encabezado traducido: ### V. BENCHMARK COMPETITIVO SOCIAL\nOBLIGATORIO: BENCHMARK_VERIFIED. Si SIN_COMPETENCIA_IDENTIFICADA, sin tabla. Si hay COMP_1..3, tabla con fila "Qué hacen / What they do" (QUE_HACE del dossier). PROHIBIDO dominios no listados. Dossier: ${d}`,
