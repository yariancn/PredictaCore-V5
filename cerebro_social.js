...
const PROMPTS = {
  ...
  BENCHMARK: (d) => `${IDIOMA}\n${REGLA_NUCLEAR}\nEscribe este encabezado traducido: ### V. BENCHMARK COMPETITIVO SOCIAL\nOBLIGATORIO: BENCHMARK_VERIFIED, UBICACION_MERCADO (CRITERIO_MERCADO) y PERFIL_NEGOCIO. E-commerce social = zona de envío; negocio local = misma ciudad. Si PYME_BOUTIQUE, PROHIBIDO mega-retailers. Si SIN_COMPETENCIA_IDENTIFICADA, sin tabla. Si COMP_1..3, tabla SOLO con esos dominios. PROHIBIDO dominios no listados. Dossier: ${d}`,
